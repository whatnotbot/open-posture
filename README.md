...
When sustained drift crosses your chosen sensitivity, Open Posture attempts a native desktop notification and always keeps an in-app fallback. Open the correction screen for a neutral directional cue, or pause and snooze whenever you want.
...
flowchart LR
  ...
  Compare -->|"sustained drift"| Alert["Native notification + in-app cue"]
...
| Alerts | Native notification attempt plus a reliable in-app fallback |
