...
| FEAT-007 Low-noise alerts | Dwell, recovery, cooldown, snooze, native attempt, stale guards and passive fallback | Posture/reliability tests and typed desktop contracts | Native delivery/manual OS checks pending | **Implemented/evidence pending** |
